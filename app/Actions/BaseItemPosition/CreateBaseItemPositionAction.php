    ...
    public function createReusedPosition(NomenclatureBaseItemPdrPosition $itemPosition, int $reuse_id): void
    {
        ...
        if ($reusePosition) {
            $itemPosition->nomenclatureBaseItemPdrCard()->create([
                ...
                'trademe' => $reusePosition->trademe,
                'drom' => $reusePosition->drom,
                'avito' => $reusePosition->avito,
                'dodson' => $reusePosition->dodson,
                'nova' => $reusePosition->nova,
                'description' => $reusePosition->description,
