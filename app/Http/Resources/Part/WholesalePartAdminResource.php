    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'prices' => [
                ...
                'pricing_ru_retail' => $this->card->priceCard->price_ru_retail,
                'pricing_ru_wholesale' => $this->card->priceCard->price_ru_wholesale,
                'pricing_mng_retail' => $this->card->priceCard->price_mng_retail,
                'pricing_mng_wholesale' => $this->card->priceCard->price_mng_wholesale,
                'pricing_jp_retail' => $this->card->priceCard->price_jp_retail,
                'pricing_jp_wholesale' => $this->card->priceCard->price_jp_wholesale,
