...
class AddListPartsAction
{
    ...
    private function createCardStructures(CarPdrPositionCard $card, NomenclatureBaseItemPdrCard $originCard = null): void
    {
            ...
            $card->priceCard()->create([
                ...
                'approximate_price' => $originCard?->price_nz_wholesale,
                'real_price' => $originCard?->price_nz_wholesale,
                ...
                'minimum_threshold_jp_retail' => $originCard?->minimum_threshold_jp_retail,
                'minimum_threshold_jp_wholesale' => $originCard?->minimum_threshold_jp_wholesale,
                'minimum_threshold_mng_retail' => $originCard?->minimum_threshold_mng_retail,
                'minimum_threshold_mng_wholesale' => $originCard?->minimum_threshold_mng_wholesale,
            ]);
